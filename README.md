...
데이터는 CSV 형식으로 제공되며,
본 프로젝트에서는 전체 데이터 중 일부를 샘플링하여 실험에 활용하였습니다.

Note: 데이터 크기 문제로 인해 GitHub에는 소량의 샘플 데이터만 포함되어 있습니다.

## 3. Preprocessing

[Back to Table of Contents](#back-to-table-of-contents)

텍스트 데이터를 모델에 입력하기 위해 다음과 같은 전처리 과정을 수행하였습니다.
...
머신러닝 및 딥러닝 모델에서 처리 가능한 입력 형태로 변환하였습니다.

## 4. Model

[Back to Table of Contents](#back-to-table-of-contents)

본 프로젝트에서는 두 가지 모델을 사용하여 성능을 비교하였습니다.
...
Note: 본 실험의 성능 수치는 동일한 데이터셋을 기준으로 비교한 결과이며,
모델 구조 비교에 초점을 둔 설계 중심 실험입니다.
